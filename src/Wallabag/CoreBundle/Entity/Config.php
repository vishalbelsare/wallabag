...
class Config
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wallabag\CoreBundle\Entity\IgnoreOriginRule", mappedBy="config", cascade={"remove"})
     * @ORM\OrderBy({"id" = "ASC"})
     */
     ...
     * @return Config
     */
    public function addIgnoreOriginRule(IgnoreOriginRule $rule)
    {
    ...
    /**
     * @return ArrayCollection<IgnoreOriginRule>
     */
