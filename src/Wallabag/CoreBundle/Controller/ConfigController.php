...
class ConfigController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if ($taggingRulesImportform->isSubmitted() && $taggingRulesImportform->isValid()) {
            ...
            if (null !== $file && $file->isValid() && 'application/json' === $file->getClientMimeType()) {
                ...
                if (\is_array($content)) {
                    ...
                    $this->addFlash(
                        'notice',
                        'flashes.config.notice.tagging_rules_imported'
                    );
                }
            }
    ...
    public function exportTaggingRulesAction()
    {
        ...
        return Response::create(
            ...
            [
                ...
                'Content-Disposition' => 'attachment; filename="tagging_rule_' . $this->getUser()->getUsername() . '.json"',
